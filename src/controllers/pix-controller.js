...
class PixController {
  ...
  static verificarChave = async (req, res) => {
    try {
      ...
      const accessToken = await authServiceAPI.returnAccessToken();
      const response = await pixService.verificarChave(
        idPix,
        emailUsuario,
        accessToken,
        verifyCode
  ...
  static reenviarCodigo = async (req, res) => {
    try {
      ...
      const accessToken = await authServiceAPI.returnAccessToken();
      const response = await pixService.reenviarCodigo(
        idPix,
        emailUsuario,
        accessToken
      );
  ...
  static buscarChavePixPorID = async (req, res) => {
    try {
      ...
      const response = await pixService.buscarChaveId(
        idPix,
        dadosUsuario,
        accessToken
      );
  ...
  static deletarChave = async (req, res) => {
    try {
      ...
      const response = await pixService.deletarChave(
        idPix,
        usuario_id,
        emailUsuario,
        accessToken
