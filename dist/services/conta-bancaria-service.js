...
var require_models = __commonJS({
  "src/models/index.js"(exports2, module2) {
    ...
    ContaBancos.belongsTo(Usuario2, { foreignKey: "usuario_id", onDelete: "CASCADE" });
    ContaBancos.belongsTo(ContaBancaria2, { foreignKey: "contaBancaria_id", onDelete: "CASCADE" });
...
var require_conta_bancos_repository = __commonJS({
  "src/repositories/conta-bancos-repository.js"(exports2, module2) {
    ...
    var { ContaBancos, ContaBancaria: ContaBancaria2, Pix, Banco } = require_models();
